...
결정: API 요청 바디도 `revocation_decision` enum(`approved|rejected`)으로 통일해 DB·API가 같은 어휘를 쓰도록 맞춘다. 상세 내용은 `docs/API명세서/revision_log/API명세서_v4_to_v5_revision_log.md` 참고.
