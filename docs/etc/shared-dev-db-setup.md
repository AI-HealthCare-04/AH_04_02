...
- ~~임시번호 재전송/검증 시도 횟수 제한은 구현하지 않았습니다~~ **[2026-07-16 정정]** 팀원
  ...
  시도 횟수 제한(5회). 자세한 내용은 `docs/deviation_log/deviation-log-2026-07-16.md` DEV-03 참고.
...
'invited_phone'` 에러로 깨졌습니다(`docs/deviation_log/deviation-log-2026-07-16.md` DEV-06). 공유 DB에
