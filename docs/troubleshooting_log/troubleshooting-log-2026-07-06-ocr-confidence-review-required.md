...
- **관련 문서**: `docs/deviation_log/deviation-log-2026-07-06-ocr-rag-integration.md` (D2 항목), `rag/contract.md` 2·3번
...
(토의 경과는 `docs/deviation_log/deviation-log-2026-07-06-ocr-rag-integration.md` 참고):
...
1. **계약 문서화**: `rag/contract.md`를 신설해 OCR↔RAG 필드 매핑, confidence 임계값 두 개(0.80 vs 0.75)의
...
2. **계약 테스트 신설**: `tests/contracts/test_ocr_contract.py` + `ocr_sample_output.json` — OCR 실제
   ...
   confidence가 실제로 다르게 처리되는가"를 회귀 테스트로 고정. `rag/contract.md` 5번 항목에 이 픽스처를
