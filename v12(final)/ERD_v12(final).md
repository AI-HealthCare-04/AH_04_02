...
>
> 최종 버전: v12(final) (2026-08-03). v11 대비 변경 내역은 `docs/revision_logs/ERD/ERD_v11_to_v12_revision_log.md`에서만 관리한다. dbdiagram.io에 바로 붙여넣을 수 있는 DBML은 `v12(final)/ERD_v12(final).dbml` 참고.
>
